...
import club.sk1er.patcher.mixins.accessors.MathHelperAccessor;
 ...
 * @author Wyvest       Port to Minecraft 1.8.9 / 1.12.2 mappings
 */
public class CompactSineLUT {
    ...
    static {
        float[] SINE_TABLE = MathHelperAccessor.getSineTable();
